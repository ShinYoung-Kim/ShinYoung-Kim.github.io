...
tag1 : '비건', tag2 : '락토', tag3 : '오보', tag4 : '락토오보', tag5 : '페스코'
...
function displayMarker(data) {
  ...
  ellipsis.innerHTML = '<img class="address_pic" src="address_pic.png"><div class="address">주소</div><div class="address_info">'+data.addr+'</div>';
  ellipsis.className = "ellipsis";
  desc.appendChild(ellipsis);

  var tele = document.createElement('div');
  tele.innerHTML = '<img class="call_pic" src="call_pic.png"><div class="call">연락처</div><div class="call_info">' + data.tele+'</div><div class="clear"></div>';
  tele.className = "tele";
  ...
  if (data.hasOwnProperty('tag5')) {
    var tag5 = document.createElement('div');
    tag5.innerHTML = data.tag5;
    tag5.className = "tag";
    desc.appendChild(tag5);
  }
  if (data.hasOwnProperty('tag6')) {
    var tag6 = document.createElement('div');
    tag6.innerHTML = data.tag6;
    tag6.className = "tag";
    desc.appendChild(tag6);
  }
